...
GRANT UPDATE (name, display_name, type, owner_user_id, status, verification_status, verification_type, updated_at, deleted_at) ON tenancy.tenants TO platform_svc;  -- workspace_counter 随 §11 v4 解耦退役(2026-09-05)
