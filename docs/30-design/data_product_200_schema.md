...
| `description`                                  | text         | NULL                                                                |                                                                                                                                                                                                      |
| `industry` / `scenario`                        | varchar(128) | NULL                                                                | 行业领域 / 业务场景。`industry` 自 2026-09-06 起与租户所属行业共用 core-utils `industry-taxonomy` 自定义清单(存码,admin 写入只认清单码;历史自由文本原样保留、展示时原样显示);`scenario` 仍是自由文本 |
