...
| P1-b | OrderService + fulfill；console-bff / admin-bff 写路径切到 orders；读路径双源过渡（先 orders，缺则回退旧谓词）                                                                                                                                                                                                                                                                                                                                                                                              | 无                              |
| P1-c | 前端：console 订单页、admin 交易订单页、待办服务端化                                                                                                                                                                                                                                                                                                                                                                                                                                                        | 无                              |
| P2-a | 折抵引擎 + consumable_share + 确认页折抵行                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | 无                              |
| P2-b | 24h 退款 + 回滚 + 退款说明页 + 平台参数                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | 无                              |
| P2-c | 自动续费引擎（到期前 N 天生成 renew 订单；free 自动续）；`expiring` 扫描；退役旧列                                                                                                                                                                                                                                                                                                                                                                                                                          | 一条 migration                  |
